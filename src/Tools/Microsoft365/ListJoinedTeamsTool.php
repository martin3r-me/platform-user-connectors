...
class ListJoinedTeamsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string { return 'user-connectors.microsoft365.teams.list'; }

    public function getDescription(): string
    {
        return 'Listet alle Microsoft-Teams, in denen der User Mitglied ist (Discovery für Channel-Send).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            return ToolResult::success($connector->listJoinedTeams($context->user));
        } catch (\Throwable $e) {
    ...
    {
        return ['category' => 'inspection', 'tags' => ['microsoft365', 'teams', 'list'],
