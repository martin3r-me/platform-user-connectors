...
class TestConnectionTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'user-connectors.ringcentral.test';
    }

    public function getDescription(): string
    {
        return 'Testet die RingCentral-Verbindung (OAuth2 Token-Validierung und API-Erreichbarkeit).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            $service = app(RingCentralConnectorService::class);
            ...
            if (!$connection) {
                return ToolResult::error('NO_CONNECTION', 'Keine RingCentral-Verbindung konfiguriert.');
            }
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['ringcentral', 'test', 'connectivity', 'telefonie'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];
